  ...
  return (
    <section id="hero" ref={sectionRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="morphing-shape absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-blue-500/15 to-purple-500/15 morph-shape" style={{ animationDelay: '2s' }}></div>
      </div>

      {/* Magnetic Field Lines */}
      <div className="absolute inset-0 opacity-10">
        <svg className="w-full h-full" viewBox="0 0 1200 800">
          <path className="magnetic-field-line" d="M100,400 Q300,200 500,400 T900,400" stroke="url(#fieldGradient)" strokeWidth="2" fill="none" opacity="0.5"/>
          <path className="magnetic-field-line" d="M150,450 Q350,250 550,450 T950,450" stroke="url(#fieldGradient)" strokeWidth="1.5" fill="none" opacity="0.3"/>
          <path className="magnetic-field-line" d="M200,350 Q400,150 600,350 T1000,350" stroke="url(#fieldGradient)" strokeWidth="1" fill="none" opacity="0.2"/>
          <defs>
            <linearGradient id="fieldGradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{ stopColor: '#F97316', stopOpacity: 1 }} />
              <stop offset="50%" style={{ stopColor: '#6B46C1', stopOpacity: 1 }} />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="floating-icons absolute inset-0 pointer-events-none">
            ...
            <div className="floating-icon absolute top-1/3 right-16 text-violet-500 opacity-40 magnetic-float" style={{ animationDelay: '1s' }}>
              <i className="fab fa-unity text-2xl"></i>
            </div>
            <div className="floating-icon absolute bottom-1/3 left-20 text-blue-500 opacity-35 magnetic-float" style={{ animationDelay: '2s' }}>
              <i className="fab fa-node-js text-2xl"></i>
            </div>
            <div className="floating-icon absolute bottom-1/4 right-10 text-orange-500 opacity-25 magnetic-float" style={{ animationDelay: '3s' }}>
