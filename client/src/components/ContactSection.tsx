        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="contact-info">
            <div className="contact-badge inline-flex items-center px-4 py-2 bg-orange-500/20 border border-orange-500/30 rounded-full mb-6">
              <span className="text-sm font-jetbrains text-orange-500">{t('contactUs')}</span>
            </div>
            
            <h2 className="contact-title text-4xl md:text-5xl font-bold mb-6 leading-tight">
              <span>{t('writeToUs')}</span>
              <br />
              <span className="magne-gradient-text gradient-shift">{t('workTogether')}</span>
            </h2>
            ...
            <div className="space-y-6 mb-12">
              {contactMethods.map((method, index) => (
                ...
                >
                  <div className={`method-icon w-12 h-12 bg-gradient-to-r ${method.gradient} rounded-lg flex items-center justify-center mr-4`}>
          ...
          <div className="contact-form-container">
            ...
            {/* Success Message */}
            {showSuccess && (
              <div className="mt-6 p-6 bg-green-500/20 border border-green-500/30 rounded-xl" data-testid="success-message">
